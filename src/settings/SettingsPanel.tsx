...
import { ipLocate, type GeoResult } from '../services/geoService'
import { loadPlaces, searchPlaces } from '../services/placesService'
...
function CityAutocomplete() {
  ...
  function pick(r: GeoResult) {
    ...
    update({ location: { lat: r.lat, lon: r.lon, name: r.name, countryCode: r.countryCode }, timezone: r.timezone ?? null })
